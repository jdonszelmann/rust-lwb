...
pub struct ParsePairSort<'src> {
    ...
    pub constructor_value: ParsePairConstructor<'src>,
}
...
#[derive(Debug, Clone)]
pub enum ParsePairConstructor<'src> {
...
impl<'src> ParsePairConstructor<'src> {
    /// What span does this parse pair occupy?
    pub fn span(&self) -> Span<'src> {
        match self {
