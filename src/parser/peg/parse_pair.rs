...
pub enum ParsePairConstructor {
    ...
    /// This is generated when a leaf constructor was executed. The only important part is the span, which represents the text that was parsed.
    /// Generated by CharacterClass and Literal.
    Text(Span),
    /// This is generated when no useful information needed to be recorded here, but still a placeholder is needed.
